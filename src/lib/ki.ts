...
// Rangos de Ki definidos en CLAUDE.md. colorToken corresponde a un token
// de color en globals.css (usable como var(--color-{colorToken})).
const KI_LEVELS: readonly KiLevel[] = [
